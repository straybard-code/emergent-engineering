...
public sealed class CreateSimulationRequest : IThanksCoinSettings, IMutualRespectSettings, IIntellectualRespectSettings, IThinkingSpeedSettings, IValidatableObject
{
    [Required]
    [StringLength(200)]
