...
public sealed class CreateExperimentRequest : IThanksCoinSettings, IMutualRespectSettings, IIntellectualRespectSettings, ILogRetentionSettings, IValidatableObject
{
    [Required]
    [StringLength(200)]
