...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<SimulationProject>(entity =>
        {
            ...
            entity.Property(project => project.EnableIntellectualRespect).HasDefaultValue(IntellectualRespectDefaults.EnableIntellectualRespect);
            ...
            entity.Property(project => project.IntellectualRespectDecayRate).HasDefaultValue(IntellectualRespectDefaults.DecayRate);
            entity.Property(project => project.IntellectualRespectDiversitySensitivity).HasDefaultValue(IntellectualRespectDefaults.DiversitySensitivity);
            entity.Property(project => project.IntellectualRespectChallengeSensitivity).HasDefaultValue(IntellectualRespectDefaults.ChallengeSensitivity);
            ...
            entity.Property(project => project.LogDetailLevel).HasMaxLength(32).HasDefaultValue(LogDetailLevels.Full);
            entity.Property(project => project.StepLogInterval).HasDefaultValue(LogRetentionDefaults.FullStepInterval);
            entity.Property(project => project.ActionLogInterval).HasDefaultValue(LogRetentionDefaults.FullActionInterval);
        ...
        modelBuilder.Entity<Scenario>(entity =>
        {
            ...
            entity.Property(item => item.EnableIntellectualRespect).HasDefaultValue(IntellectualRespectDefaults.EnableIntellectualRespect);
            ...
            entity.Property(item => item.IntellectualRespectDecayRate).HasDefaultValue(IntellectualRespectDefaults.DecayRate);
            entity.Property(item => item.IntellectualRespectDiversitySensitivity).HasDefaultValue(IntellectualRespectDefaults.DiversitySensitivity);
            entity.Property(item => item.IntellectualRespectChallengeSensitivity).HasDefaultValue(IntellectualRespectDefaults.ChallengeSensitivity);
            ...
            entity.Property(item => item.LogDetailLevel).HasMaxLength(32).HasDefaultValue(LogDetailLevels.Full);
            entity.Property(item => item.StepLogInterval).HasDefaultValue(LogRetentionDefaults.FullStepInterval);
            entity.Property(item => item.ActionLogInterval).HasDefaultValue(LogRetentionDefaults.FullActionInterval);
        });
